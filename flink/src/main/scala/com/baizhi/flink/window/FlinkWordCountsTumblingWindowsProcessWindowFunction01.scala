...
object FlinkWordCountsTumblingWindowsProcessWindowFunction01 {
  def main(args: Array[String]): Unit = {
    ...
    dataStream.flatMap(_.split("\\s+"))
      ...
      .process(new ProcessWindowFunction[(String,Int),(String,Int),String,TimeWindow]{ //ProcessWindowFunction可以操作状态还可以获取所有的元数据
      ...
      .print()
    environment.execute("FlinkWordCountsTumblingWindowsProcessWindowFunction01")
  }
}
